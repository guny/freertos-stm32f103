...
#define FRAME_HEADER0                0x5A//GusRigister.Rigister[0x03]//0x5A
#define FRAME_HEADER1                0XA5//GusRigister.Rigister[0x0A]//0xA5
...
#define _RECEIVE_CRC_ENABLE         0//(0x10 == (GusRigister.Rigister[0x0C] & 0x10))
