	...
	while(1 == comGetChar(COM2, &temp))
	{
		...
		else if(2 == ReceiverStatus)
		{
			...
			if(1 <= conuter++)
			{
				...
				if(FRAMER_LENGTH_MAX < frame_length)
					ReceiverStatus = 0;
				else
					ReceiverStatus = 3;
			}
...
const uint8_t buff0[] = {0x5a,0xa5,0x06,0x83,0x23,0x09,0x1,0x55,0x03};// --探头
const uint8_t buff1[] = {0x5a,0xa5,0x06,0x83,0x23,0x09,0x1,0x55,0x03};
const uint8_t buff2[] = {0x5a,0xa5,0x06,0x83,0x23,0x09,0x1,0x55,0x02};// --点线
const uint8_t buff3[] = {0x5a,0xa5,0x06,0x83,0x23,0x09,0x1,0x55,0x02};
const uint8_t buff4[] = {0x5a,0xa5,0x06,0x83,0x23,0x09,0x1,0x55,0x04};// --能量加
const uint8_t buff5[] = {0x5a,0xa5,0x06,0x83,0x23,0x09,0x1,0x55,0x05};// --能量减
const uint8_t buff6[] = {0x5a,0xa5,0x06,0x83,0x23,0x09,0x1,0x55,0x06};// --持续时间加
const uint8_t buff7[] = {0x5a,0xa5,0x06,0x83,0x23,0x09,0x1,0x55,0x07};// --持续时间减
const uint8_t buff8[] = {0x5a,0xa5,0x06,0x83,0x23,0x09,0x1,0x55,0x08};// --间歇时间加
const uint8_t buff9[] = {0x5a,0xa5,0x06,0x83,0x23,0x09,0x1,0x55,0x09};// --间歇时间减
const uint8_t buffa[] = {0x5a,0xa5,0x06,0x83,0x23,0x09,0x1,0x55,0x0a};
const uint8_t buffb[] = {0x5a,0xa5,0x06,0x83,0x23,0x09,0x1,0x55,0x0a};
const uint8_t buffc[] = {0x5a,0xa5,0x06,0x83,0x23,0x09,0x1,0x55,0x0b};
const uint8_t buffd[] = {0x5a,0xa5,0x06,0x83,0x23,0x09,0x1,0x55,0x0b};
static uint8_t buffe[] = {0x5a,0xa5,0x06,0x83,0x30,0x00,0x1,0x00,0x00};
