...
void cloud_process(void)
{
	...
	if(0 == CloudProtocolGetOnePacket())
	{
		...
		else if(0 == strncmp((const char *)FramerBuff + 4, "{\"pay\":", 7))
		{
			...
			comSendBuf(COM3, buffe, sizeof(buffe));
		}
		memset(FramerBuff, 0x00, sizeof(FramerBuff));
		frame_length = 0;
	}
